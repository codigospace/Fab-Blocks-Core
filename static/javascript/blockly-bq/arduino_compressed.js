...
Blockly.Arduino.scrub_ = function(a, d) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
        ...
        b && (c += Blockly.Generator.prefixLines(b, "// ") + "\n");
        for (var e = 0; e < a.inputList.length; e++) a.inputList[e].type == Blockly.INPUT_VALUE && (b = a.inputList[e].connection.targetBlock()) && (b = Blockly.Generator.allNestedComments(b)) && (c += Blockly.Generator.prefixLines(b, "// "))
    }
