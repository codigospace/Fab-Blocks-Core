...
(function(factory) {
    ...
    var load = function(options, programmingLanguage) {
            ...
            with(obj) {
                if (programmingLanguage === 'cpp') {
                    ...
                    __p += 'change_base = lambda number, base_destiny: format(int(number), {"DEC": "d", "HEX": "x", "OCT": "o", "BIN": "b"}[base_destiny])\n' +
                        'change_base(' + ((__t = (value_num)) == null ? '' : __t) +
                        ',' +
                        ((__t = (convertion)) == null ? '' : __t)+ ')';
                }
            }
        ...
        // libraries python
        this["JST"]["time_library"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["math_library"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["random_library"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["analog_library"] = function(obj) {
            obj || (obj = {});
            var __t, __p = '',
                __e = _.escape;
            with(obj) {
        ...
        this["JST"]["base_map"] = function(obj) {
            ...
            with(obj) {
                if (programmingLanguage === 'cpp') {
                    ...
                    __p += 'base_map = lambda value_num, value_dmax: (value_num / 1023) * value_dmax\n' +
                        'basemap(' +
                        ((__t = (value_num)) == null ? '' : __t) +
                        ',' +
                        ((__t = (value_dmax)) == null ? '' : __t) +
            ...
            with(obj) {
                if (programmingLanguage === 'cpp') {
                    ...
                    __p += 'compare_texts = lambda a, b: a.lower() == b.lower()\n' +
                        'compare_texts(' + ((__t = (string1)) == null ? '' : __t) +
                        ',' +
                        ((__t = (string2)) == null ? '' : __t) +
                        ')';
                }
        ...
        this["JST"]["text_substring"] = function(obj) {
            ...
            with(obj) {
                if (programmingLanguage === 'cpp') {
                    ...
                    'recort_text(' + ((__t = (string1)) == null ? '' : __t) +
                    ',' +
                    ((__t = (from)) == null ? '' : __t) +
                    ',' +
                    ((__t = (to)) == null ? '' : __t) +
        ...
        Blockly.Blocks.bq_led_2 = {
            ...
            init: function() {
                ...
                this.appendDummyInput().appendField(new Blockly.FieldImage('/media/DECLARARMODULAR.png', 30, 30, "*"))
        ...
        Blockly.Arduino.Sound_sensor_3 = function(block) {
            ...
            programmingLanguage === 'python' && (Blockly.Arduino.definitions_['import_analog_library'] = JST['analog_library']({}));
        ...
        Blockly.Arduino.base_delay = function() {
            ...
            Blockly.Arduino.definitions_['define_mod_time'] = JST['time_library']({});
        ...
        Blockly.Blocks.bq_bluetooth_def = {
            ...
            init: function() {
                this.setColour(RoboBlocks.LANG_COLOUR_COMMUNICATION);
                this.appendDummyInput().appendField(RoboBlocks.locales.getKey('LANG_BQ_BLUETOOTH_DEF')).appendField(new Blockly.FieldImage('/media/blocks/bqmod03.png', 208 * options.zoom, 100 * options.zoom));
        ...
        Blockly.Arduino.controls_execute = function() {
            ...
            if ((programmingLanguage === 'cpp' && content.match(/^#include /)) || 
                (programmingLanguage === 'python' && content.match(/^import /))) {
        ...
        Blockly.Arduino.logic_boolean = function() {
            ...
            var code = booleanMap[programmingLanguage][this.getFieldValue('BOOL')];
        ...
        Blockly.Arduino.logic_operation = function() {
            ...
            var operator = operatorMap[programmingLanguage][this.getFieldValue('OP')];
        ...
        Blockly.Arduino.math_random = function() {
            ...
            programmingLanguage === 'python' && (Blockly.Arduino.definitions_['define_mod_math'] = JST['random_library']({}));
        ...
        Blockly.Arduino.math_single = function() {
            ...
            if (programmingLanguage === 'python') {
                Blockly.Arduino.definitions_['define_mod_math'] = JST['math_library']({});
            }            
            ...
            switch (operator) {
                case 'ABS':
                    ...
                    break;
                case 'ROOT':
                    code += (programmingLanguage === 'python' ? 'math.sqrt(' : 'sqrt(') + arg + ')';
                    break;
                case 'LN':
                    code += (programmingLanguage === 'python' ? 'math.log(' : 'log(') + arg + ')';
                    break;
                case 'EXP':
                    code += (programmingLanguage === 'python' ? 'math.exp(' : 'exp(') + arg + ')';
                    break;
                case 'POW10':
                    code += (programmingLanguage === 'python' ? '10**' + arg : 'exp(10,' + arg + ')');
                    break;
                case 'SIN':
                    code += 'sin(' + arg + ' / 180 * ' + PI + ')';
                    break;
            ...
            switch (operator) {
                case 'LOG10':
                    ...
                    code += a['code'];
                    arg = a['pin'];
                    code += (programmingLanguage === 'python' ? 'math.log(' + arg + ') / math.log(10)' : 'log(' + arg + ') / log(10)');
                    break;
                case 'ASIN':
        ...
        Blockly.Arduino.procedures_defreturn = function() {
            ...
            if (returnValue) {
                ...
                returnValue = a['code'];
                returnValue += (programmingLanguage === 'cpp' ? '  ' : '    ') + 'return ' + a['pin'] + ';\n';
            }
            var args = this.paramString;
        ...
        Blockly.Arduino.text_append = function() {
            ...
            (programmingLanguage === 'cpp' ? (code += varName + ' += String(' + argument0 + ');\n') : null);
            return code;
        };
        ...
        Blockly.Arduino.text_join = function() {
            ...
            if (this.itemCount_ === 0) {
                ...
                programmingLanguage === 'python' ? 
                (code += 'str(' + argument0 + ')') :
                (programmingLanguage === 'cpp' ? (code += 'String(' + argument0 + ')') : null);
                return [code, Blockly.Arduino.ORDER_UNARY_POSTFIX];
            } else {
                ...
                programmingLanguage === 'python' ? 
                (final_line = 'str(' + i) :
                (programmingLanguage === 'cpp' ? (final_line = 'String(' + i) : null);
        ...
        Blockly.Arduino.variables_global = function() {
            ...
            if (varValue.search('"') >= 0 || varValue.search('substring\\(') >= 0) {
                ...
                programmingLanguage === 'python' ? 
                (Blockly.Arduino.definitions_['declare_var' + varName] = varName + ': ' + {'String': 'str', 'int': 'int', 'long': 'int', 'byte': 'int', 'float': 'float'}[varType] + '=' + varValue + '\n') :
                (programmingLanguage === 'cpp' ? (Blockly.Arduino.definitions_['declare_var' + varName] = varType + ' ' + varName + '=' + varValue + ';') : null);
                ...
                for (i in Blockly.Arduino.definitions_) {
                    if (Blockly.Arduino.definitions_[i].search(varValue) >= 0) {
                        ...
                        (programmingLanguage === 'cpp' ? (Blockly.Arduino.definitions_['declare_var' + varName] = varType + ' ' + varName + ';\n') : null);
                        
                        programmingLanguage === 'python' ? 
                        (Blockly.Arduino.setups_['define_var' + varName] = varName + ' = ' + varValue + ';\n') :
                        (programmingLanguage === 'cpp' ? (Blockly.Arduino.setups_['define_var' + varName] = varName + '= ' + varValue + ';\n') : null);
                        break;
                    }
                }
            } else if (varValue[0] === '{') {
        ...
        Blockly.Arduino.variables_local = function() {
            ...
            if (varValue.search('"') >= 0 || varValue.search('substring\\(') >= 0) {
                ...
                (programmingLanguage === 'cpp' ? (code += varType + ' ' + varName + '=' + varValue + ';\n') : null);
